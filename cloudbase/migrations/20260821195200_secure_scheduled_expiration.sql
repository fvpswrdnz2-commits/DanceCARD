drop function if exists public.expire_dance_cards(timestamptz);
...
comment on function public.expire_dance_cards(timestamptz, text) is
  'Daily expiration maintenance; accepts service_role or the scheduled function secret whose SHA-256 digest is stored here';
