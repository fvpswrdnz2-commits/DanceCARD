...
-- DanceCARD 2.0 studios are city-wide card scopes; branch addresses are reference information only.
...
select city.id, studio.name, studio.branch_info, studio.status, '00000000-0000-4000-8000-000000000001'
from public.cities as city
join (values
  (
    '北京',
    '嘉禾舞社',
    E'雍和宫店：北京市东城区安定门东大街28号雍和大厦D座502\n广安门店：北京市西城区广安门外大街168号朗琴国际B座912\n国贸店：北京市朝阳区东三环中路39号建外SOHO东区B座18层1802\n望京店：北京市朝阳区望京悠乐汇C座商业2层\n长楹店：北京市朝阳区龙湖长楹天街商业步行街东区F区102\n平房桥专业班：北京市朝阳区平房路48号小狼国际院内\n紫竹桥店：北京市海淀区紫竹院路31号华澳中心嘉慧苑东侧B2\n西二旗店：北京市海淀区上地街道辉煌国际西6号楼320室\n中关村店：北京市海淀区中关村大街19号新中关购物中心B座南翼12层1208\n马家堡店：北京市丰台区搜宝商务中心底商B1层202\n通州店：北京市通州区新华西街58号万达广场C座703',
    'active'
  ),
  (
    '上海',
    'CASTER舞蹈教室',
    E'上海大悦城南座店：上海市静安区西藏北路166号大悦城南座5层501\n海梦一方店：上海市闵行区莲花南路1389号海梦一方L3-04\n瑞虹天地月亮湾店：上海市虹口区瑞虹路188号瑞虹天地月亮湾LG层B116B\n虹口足球场店：上海市虹口区东江湾路444号虹口足球场2区C座',
    'active'
  ),
  (
    '上海',
    'GH5 DANCE STUDIO',
    '玫瑰坊店：上海市长宁区长宁路890号玫瑰坊东区2楼F1室',
    'active'
  )
) as studio(city_name, name, branch_info, status) on studio.city_name = city.name
...
join (values
  ('10000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000002', 'CASTER舞蹈教室', '小舞', 'dancecard-dev-user', 8, 45.00::numeric, 90, 'all', array[]::text[], null::varchar, null::varchar, '出差前用不完，可联系详聊。'::varchar, 'active', null::varchar, interval '4 hours'),
  ('10000000-0000-4000-8000-000000000002', '00000000-0000-4000-8000-000000000001', 'CASTER舞蹈教室', '阿新', 'dancecard-dev-admin', 10, 60.00::numeric, 60, 'specified', array['jazz']::text[], null::varchar, '工作日可用'::varchar, null::varchar, 'active', null::varchar, interval '1 hour'),
  ('10000000-0000-4000-8000-000000000003', '00000000-0000-4000-8000-000000000001', 'CASTER舞蹈教室', '阿新', 'dancecard-dev-admin', 5, 60.00::numeric, 45, 'specified', array['hip-hop', 'house']::text[], null::varchar, null::varchar, null::varchar, 'active', null::varchar, interval '2 hours'),
  ('10000000-0000-4000-8000-000000000004', '00000000-0000-4000-8000-000000000002', 'CASTER舞蹈教室', '小舞', 'dancecard-dev-user', 3, 39.00::numeric, 30, 'specified', array[]::text[], 'Heels'::varchar, null::varchar, '手动隐藏样例'::varchar, 'hidden', 'user'::varchar, interval '3 hours'),
  ('10000000-0000-4000-8000-000000000005', '00000000-0000-4000-8000-000000000002', 'CASTER舞蹈教室', '小舞', 'dancecard-dev-user', 2, 35.00::numeric, -1, 'all', array[]::text[], null::varchar, null::varchar, '过期样例'::varchar, 'hidden', 'expired'::varchar, interval '5 hours'),
  ('10000000-0000-4000-8000-000000000006', '00000000-0000-4000-8000-000000000003', 'CASTER舞蹈教室', '停用用户', 'dancecard-disabled', 6, 30.00::numeric, 100, 'all', array[]::text[], null::varchar, null::varchar, '用户被停用，不得公开'::varchar, 'active', null::varchar, interval '6 hours')
) as sample(
